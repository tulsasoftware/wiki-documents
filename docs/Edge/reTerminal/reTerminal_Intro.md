...
- [reTerminal and Pi camera modules](https://wiki.seeedstudio.com/reTerminal-piCam/)
...
<div class="independent_container">
    <div class="independent_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>OS Installation</font></div>
    ...
    <div class="independent_item" style={{textAlign: 'center'}}>
            <div class="independent_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>Software</font></div>
